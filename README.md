...
11. *OPTIONAL*: After you're done viewing the hexadecimal code, you may open the file ending in `.hex.txt` for further analysis and/or debugging if you wish. It's created in the same directory as the script.
